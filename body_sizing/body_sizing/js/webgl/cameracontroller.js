...
var CameraController = Class.create({
	...
	initialize: function(element, opt_canvas, opt_context) {
		...
		element.addEventListener('mousedown',function(controller) {
			return function(ev) {
		...
		document.addEventListener('mouseup',function(controller) {
			return function(ev) {
		...
		document.addEventListener('mousemove',function(controller) {
			return function(ev) {
